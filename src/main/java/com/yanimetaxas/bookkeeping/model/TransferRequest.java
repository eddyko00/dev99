...
/**
 * Request object describing a balanced, multi-legged monetary transaction
 * between two or more accounts. A request must have at least two legs.
 * Different money currencies are allowed as long as the total balance for the
 * legs with the same currency is zero.
 * <p>
 * This class uses a nested builder state machine to provide a clear building
 * path with compile-time safety and coding guidance.
 *
 * @author yanimetaxas
 * @since 14-Nov-14
 */
public final class TransferRequest implements Serializable {
    ...
    public interface TypeStep {
        ...
        /**
         * @param transactionType the transaction type for grouping transactions
         * or other purposes
         * @return the next build step
         */
